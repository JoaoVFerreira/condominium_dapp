...
export default function Pagination(props: Props) {
  ...
  const pagesQty = Math.ceil(Number(props.count) / props.pageSize)
  const pages = [];
  ...
  return (
    <div className="card-footer px-3 boder-0 d-flex flex-column flex-lg-row align-items-center justify-content-between">
