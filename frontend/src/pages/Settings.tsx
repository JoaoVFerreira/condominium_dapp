...
export default function Settings() {
  ...
  function btnSaveClick() {
    ...
    upgrade(contract).then((tx) => {
      setMessage('Settings saved! It may take some minutes to have effect.')
    }).catch((err: any) => {
      setMessage(err.message);
    })
  }
                ...
                <div className="row ms-3">
                  <div className="col-md-6 mb-3">
                    <div className="form-group">
                      ...
                      <input className="form-control" type="text" id="adapter" value={process.env.REACT_APP_ADAPTER_ADDRESS} disabled={true}/>
                    </div>
                  </div>
                </div>
                <div className="row ms-3">
                  <div className="col-md-6 mb-3">
                    <div className="form-group">
                      ...
                      <div className="input-group input-group-outline">
                        <input className="form-control" type="text" id="contract" value={contract} onChange={ev => setContract(ev.target.value)}/>
                      </div>
                    </div>
                  </div>
                </div>
